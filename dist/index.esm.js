...
var templateObject_1$S, templateObject_2$k, templateObject_3$a;
...
var TooltipText = styled(Text)(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  text-decoration: ", ";\n  text-underline-offset: 0.1em;\n"], ["\n  text-decoration: ",
    ";\n  text-underline-offset: 0.1em;\n"])), function (_a) {
    var theme = _a.theme;
...
var Icon$S = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: "90", height: "90", href: "/images/cake-bg-dark.png" })));
};
...
var Icon$G = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React.createElement("image", { width: "48", height: "48", href: "/images/Ticket.png" })));
};
...
var templateObject_1$L, templateObject_2$j, templateObject_3$9, templateObject_4$5;
...
var StyledBalanceInput = styled(Box)(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"], ["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var Dropdown = function (_a) {
    var target = _a.target, _b = _a.position, position = _b === void 0 ? "bottom" : _b, children = _a.children, id = _a.id;
    return (React.createElement(Container$3, { id: id },
        target,
...
var StyledLink$1 = styled(Text)(templateObject_1$s || (templateObject_1$s = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var templateObject_1$q, templateObject_2$c, templateObject_3$8;
...
var templateObject_1$m, templateObject_2$a, templateObject_3$7, templateObject_4$4, templateObject_5$3, templateObject_6$2, templateObject_7$1;
...
var templateObject_1$l, templateObject_2$9, templateObject_3$6, templateObject_4$3, templateObject_5$2;
...
var templateObject_1$k, templateObject_2$8, templateObject_3$5;
...
var Connector = styled.div(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  position: absolute;\n  width: 4px;\n  height: 100%;\n  top: 50%;\n  left: calc(50% - 2px);\n  background-color: ", ";\n"], ["\n  position: absolute;\n  width: 4px;\n  height: 100%;\n  top: 50%;\n  left: calc(50% - 2px);\n  background-color: ", ";\n"])), function (_a) {
    var theme = _a.theme, status = _a.status;
...
var ChildrenLeftWrapper = styled(ChildrenWrapper)(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  display: none;\n  ", " {\n    display: block;\n    margin-right: 16px;\n  }\n"], ["\n  display: none;\n  ", " {\n    display: block;\n    margin-right: 16px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var templateObject_1$i, templateObject_2$7, templateObject_3$4, templateObject_4$2, templateObject_5$1, templateObject_6$1;
...
var defaultTranslationState = {
    translations: [],
    setTranslations: function () { return undefined; },
};
var TranslationsContext = createContext(defaultTranslationState);

var variableRegex = /%(.*?)%/;
var replaceDynamicString = function (foundTranslation, fallback) {
    var stringToReplace = variableRegex.exec(foundTranslation)[0];
    // const indexToReplace = foundTranslation.split(' ').indexOf(stringToReplace)
    var fallbackValueAtIndex = fallback.split(" ")[0];
    return foundTranslation.replace(stringToReplace, fallbackValueAtIndex);
};
var getTranslation = function (translations, translationId, fallback) {
    var foundTranslation = translations.find(function (translation) {
        return translation.data.stringId === translationId;
    });
    if (foundTranslation) {
        var translatedString = foundTranslation.data.text;
        var includesVariable = translatedString.includes("%");
        if (includesVariable) {
...
var useI18n = function () {
    var translations = useContext(TranslationsContext).translations;
    return function (translationId, fallback) {
...
var templateObject_1$d, templateObject_2$4, templateObject_3$2, templateObject_4$1;
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 160 40" }, props),
        React.createElement("image", { width: "160", height: "40", href: isDark
                ? "/images/hexdex5.png"
                : "/images/hexdex5.png" })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement("img", { src: "/images/hexdex5.png", className: "mobile-icon", width: "100px", height: "30px" }),
        React.createElement(Logo$1, { className: "desktop-icon", isDark: isDark })));
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "12px" }, isPushed ? (React.createElement(Icon$s, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$t, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Defix home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Defix home page" }, innerLogo))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: currentLang === "en" ? "Connect to a wallet" : "Conectarse a una Wallet", onDismiss: onDismiss }, connectors.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); })));
};
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: currentLang === "en" ? "Your wallet" : "Tu wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://bscscan.com/address/" + account, mr: "16px" }, currentLang === "en" ? "View on BscScan" : "Ver en BscScan"),
            React.createElement(CopyToClipboard, { toCopy: account }, currentLang === "en" ? "Copy Address" : "Copiar dirección")),
...
var useWalletModal = function (login, logout, account, currentLang) {
    var onPresentConnectModal = useModal(React.createElement(ConnectModal, { currentLang: currentLang || "en", login: login }))[0];
    var onPresentAccountModal = useModal(React.createElement(AccountModal, { currentLang: currentLang || "en", account: account || "", logout: logout }))[0];
...
var SubNavContainer = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  justify-content: space-between;\n"])));
...
var ConnectContainer = styled.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])));
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(SubNavContainer, null,
                React.createElement(ConnectContainer, null,
                    ...
                    React.createElement(StyledLinkContainer, null, links.map(function (entry) {
                        return (React.createElement(StyledNavLink, { key: entry.href, isActive: entry.href === location.pathname },
                            React.createElement(MenuLink, { style: { width: 'max-content' }, href: entry.href },
                ...
                React.createElement(ConnectContainer, null,
                    React.createElement(Text, { color: "textSubtle", mx: 10, bold: true }, "$" + (cakePriceUsd ? cakePriceUsd.toFixed(4) : 0)),
                    React.createElement(UserBlock, { currentLang: currentLang, account: account, login: login, logout: logout }),
                    React.createElement(Dropdown, { id: "langs-container", position: "top-right", target: React.createElement(Button, { mx: 0, variant: "text" },
                            React.createElement(Text, { color: "textSubtle" }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React.createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () {
                            setLang(lang);
                        }, 
                        // Safari fix
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#2a4cca", background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#000000", dropdown: "#1E1D20", invertedContrast: "#FFFFFF", input: "#eeeaf4", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#EFF4F5", text: "#5E7FA3", textDisabled: "#BDC2C4", disabled: "#E9EAEB", textSubtle: "#5E7FA3", borderColor: "#262948", card: "#FFFFFF", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#000000", backgroundDisabled: "#1f1f1f", contrast: "#FFFFFF", dropdown: "#F6F6F6", invertedContrast: "#191326", input: "#1b1d31", inputSecondary: "#d7caec", tertiary: "#353547", text: "#e7e8ea", textDisabled: "#666171", disabled: "#1f1f1f", textSubtle: "#ffd800", borderColor: "#262948", card: "#1b1d31", gradients: {
...
export { Icon$1w as AddIcon, Alert, Icon$1v as ArrowBackIcon, Icon$1u as ArrowDownIcon, Icon$1t as ArrowDropDownIcon, Icon$1s as ArrowDropUpIcon, Icon$1r as ArrowForwardIcon, Icon$1q as ArrowUpIcon, Icon$1p as AutoRenewIcon, BackgroundImage, BalanceInput, GridLayout$1 as BaseLayout, Icon$1o as BinanceIcon, Icon$1y as BlockIcon, Box, Breadcrumbs, Icon$1n as BunnyPlaceholderIcon, Button, ButtonMenu$1 as ButtonMenu, ButtonMenuItem, Icon$1k as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1l as CardViewIcon, Icon$1m as Cards, GridLayout as CardsLayout, Icon$1i as ChartIcon, Checkbox, Icon$1A as CheckmarkCircleIcon, Icon$1h as CheckmarkIcon, Icon$1g as ChevronDownIcon, Icon$1f as ChevronLeftIcon, Icon$1e as ChevronRightIcon, Icon$1d as ChevronUpIcon, Icon$1j as CircleOutlineIcon, Icon$1c as CloseIcon, Icon$1b as CogIcon, Icon$1a as CommunityIcon, ConnectorNames, Icon$19 as CopyIcon, Icon$18 as CrownIcon, Dropdown, Icon$1z as ErrorIcon, ExpandableButton, ExpandableLabel, FallingBunnies, Flex, Heading, Icon$17 as HelpIcon, Icon$16 as HistoryIcon, IconButton, Image, Icon$1x as InfoIcon, Input$1 as Input, Icon$15 as LaurelLeftIcon, Icon$14 as LaurelRightIcon, Link, LinkExternal, Icon$13 as ListViewIcon, Icon$12 as LogoIcon, Icon$11 as LogoRoundIcon, Icon$10 as MedalBronzeIcon, Icon$$ as MedalGoldIcon, Icon$_ as MedalPurpleIcon, Icon$Z as MedalSilverIcon, Icon$Y as MedalTealIcon, Menu, Icon$X as MetamaskIcon, Icon$W as MinusIcon, Modal, ModalBackButton, ModalBody, ModalCloseButton, ModalContainer, ModalHeader, ModalProvider, ModalTitle, Icon$V as NoProfileAvatarIcon, NotificationDot, Icon$U as OpenNewIcon, Icon$S as PancakeRoundIcon, PancakeToggle, Icon$T as PancakesIcon, Icon$Q as PlayCircleOutlineIcon, Icon$R as PocketWatchIcon, Icon$P as PrizeIcon, Progress, Icon$M as ProgressBunny, Radio, Icon$w as RefreshIcon, Icon$O as RemoveIcon, ResetCSS, Icon$C as SearchIcon, Skeleton, Slider, Spinner, Step, Stepper, Svg, Icon$B as SwapVertIcon, Icon$A as SyncAltIcon, Tab, ButtonMenu as TabMenu, Tag, Icon$J as TeamPlayerIcon, Icon$I as TestnetIcon, Text, Icon$H as Ticket, Icon$G as TicketRound, Icon$F as TimerIcon, ToastContainer, Toggle, TooltipText, Icon$E as TrophyGoldIcon, Icon$D as TuneIcon, Icon$N as VerifiedIcon, Icon$z as VolumeOffIcon, Icon$y as VolumeUpIcon, Icon$L as WaitIcon, Icon$x as WarningIcon, Icon$K as Won, variants$2 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useI18n, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
