...
var TooltipText = styled__default['default'](Text)(templateObject_1$Q || (templateObject_1$Q = __makeTemplateObject(["\n  text-decoration: ", ";\n  text-underline-offset: 0.1em;\n"], ["\n  text-decoration: ",
    ";\n  text-underline-offset: 0.1em;\n"])), function (_a) {
    var theme = _a.theme;
...
var Icon$S = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: "90", height: "90", href: "/images/cake-bg-dark.png" })));
};
...
var Icon$G = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 48 48" }, props),
        React__default['default'].createElement("image", { width: "48", height: "48", href: "/images/Ticket.png" })));
};
...
var StyledBalanceInput = styled__default['default'](Box)(templateObject_1$J || (templateObject_1$J = __makeTemplateObject(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"], ["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 16px;\n  box-shadow: ", ";\n  padding: 8px 16px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var Dropdown = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, { id: id },
        target,
...
var StyledLink$1 = styled__default['default'](Text)(templateObject_1$s || (templateObject_1$s = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var Connector = styled__default['default'].div(templateObject_1$i || (templateObject_1$i = __makeTemplateObject(["\n  position: absolute;\n  width: 4px;\n  height: 100%;\n  top: 50%;\n  left: calc(50% - 2px);\n  background-color: ", ";\n"], ["\n  position: absolute;\n  width: 4px;\n  height: 100%;\n  top: 50%;\n  left: calc(50% - 2px);\n  background-color: ", ";\n"])), function (_a) {
    var theme = _a.theme, status = _a.status;
...
var ChildrenLeftWrapper = styled__default['default'](ChildrenWrapper)(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  display: none;\n  ", " {\n    display: block;\n    margin-right: 16px;\n  }\n"], ["\n  display: none;\n  ", " {\n    display: block;\n    margin-right: 16px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.md;
});
...
var TranslationsContext = React.createContext(defaultTranslationState);
...
var useI18n = function () {
    var translations = React.useContext(TranslationsContext).translations;
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 160 40" }, props),
        React__default['default'].createElement("image", { width: "160", height: "40", href: isDark
                ? "/images/hexdex5.png"
                : "/images/hexdex5.png" })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("img", { src: "/images/hexdex5.png", className: "mobile-icon", width: "100px", height: "30px" }),
        React__default['default'].createElement(Logo$1, { className: "desktop-icon", isDark: isDark })));
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "12px" }, isPushed ? (React__default['default'].createElement(Icon$s, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$t, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Defix home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Defix home page" }, innerLogo))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: currentLang === "en" ? "Connect to a wallet" : "Conectarse a una Wallet", onDismiss: onDismiss }, connectors.map(function (entry, index) { return (React__default['default'].createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); })));
};
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: currentLang === "en" ? "Your wallet" : "Tu wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://bscscan.com/address/" + account, mr: "16px" }, currentLang === "en" ? "View on BscScan" : "Ver en BscScan"),
            React__default['default'].createElement(CopyToClipboard, { toCopy: account }, currentLang === "en" ? "Copy Address" : "Copiar dirección")),
...
var useWalletModal = function (login, logout, account, currentLang) {
    var onPresentConnectModal = useModal(React__default['default'].createElement(ConnectModal, { currentLang: currentLang || "en", login: login }))[0];
    var onPresentAccountModal = useModal(React__default['default'].createElement(AccountModal, { currentLang: currentLang || "en", account: account || "", logout: logout }))[0];
...
var SubNavContainer = styled__default['default'].div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  justify-content: space-between;\n"])));
...
var ConnectContainer = styled__default['default'].div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n"])));
    ...
    return (React__default['default'].createElement(Wrapper, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(SubNavContainer, null,
                React__default['default'].createElement(ConnectContainer, null,
                    ...
                    React__default['default'].createElement(StyledLinkContainer, null, links.map(function (entry) {
                        return (React__default['default'].createElement(StyledNavLink, { key: entry.href, isActive: entry.href === location.pathname },
                            React__default['default'].createElement(MenuLink, { style: { width: 'max-content' }, href: entry.href },
                ...
                React__default['default'].createElement(ConnectContainer, null,
                    React__default['default'].createElement(Text, { color: "textSubtle", mx: 10, bold: true }, "$" + (cakePriceUsd ? cakePriceUsd.toFixed(4) : 0)),
                    React__default['default'].createElement(UserBlock, { currentLang: currentLang, account: account, login: login, logout: logout }),
                    React__default['default'].createElement(Dropdown, { id: "langs-container", position: "top-right", target: React__default['default'].createElement(Button, { mx: 0, variant: "text" },
                            React__default['default'].createElement(Text, { color: "textSubtle" }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React__default['default'].createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () {
                            setLang(lang);
                        }, 
                        // Safari fix
